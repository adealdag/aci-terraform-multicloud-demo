...
variable "aci_url_site3" {
  description = "URL for CISCO APIC on Site 3"
}
...
# Public Cloud variables

variable "aws_account" {
  description = "AWS Account ID to use for tenant"
}

variable "azure_account" {
  description = "MS Azure Account ID to use for tenant"
}
